...
public class ControlPerson {
    ...
    public void insert(ModelPerson mod) {
        ...
        try {
            conecta.conexao();
            PreparedStatement pst = conecta.conn.prepareStatement("INSERT INTO person (id, first_name, last_name, phone_number, office, profile_facebook, register_date) VALUES (?, ?, ?, ?, ?, ?, ?)");
    ...
    public void update(ModelPerson mod, int id) {
        conecta.conexao();
        try {
            PreparedStatement pst = conecta.conn.prepareStatement("UPDATE person SET first_name= ?, last_name= ?, phone_number= ?, office= ?, profile_facebook= ?, register_date=? WHERE id=?");
