...
import com.Alanjro_jr.util.FillCombo;
...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("CRIMINAL SECURITY DETECTION SYSTEM");
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 370, 40));
    ...
    public void login() {
        con.conexao();
        try {
            con.executaSQL("SELECT * FROM login WHERE username='" + combo_user.getSelectedItem() + "'");
            con.rs.first();
            if (con.rs.getString("password").equals(txt_pass.getText())) {
